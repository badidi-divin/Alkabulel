                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="GET">
                               <input type="text" class="au-input au-input--xl" placeholder="Entrer le Nom du plat à chercher..." name="mot1" value="<?php echo ($mot1) ?>"/>
                            ...
                            <?php if ($_SESSION['role']=="admin") {
                             ...
                             ?>
                            <a href="ajout-plat.php" class="btn btn-primary">Ajout Plat</a>
                            <?php
                                }
                            ?>
