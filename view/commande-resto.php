<?php 
    ...
    require_once('../../model/select-commande-resto.php');
 ?>
<!DOCTYPE html>
<html lang="en">
                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                            ...
                                            <td>
                                             ...
                                             ?>
                                                <a onclick="return confirm('Etes-Vous sûr?')" href="../../model/sup-commande_resto.php?id=<?= $et['id'] ?>" class="btn btn-danger">Delete</a>
                                            <?php
                                                }
                                            ?>
                                                <a  href="detail-resto.php?id=<?= $et['code_commande']; ?>" class="btn btn-success">Detail de la Commande</a>
                                            </td>
                                             </tr>
                                               <?php
                                            }
