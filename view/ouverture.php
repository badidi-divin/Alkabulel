<?php 
    ...
    require_once('../model/select-ouverture.php');
 ?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            ...
                            <a href="ajouter-ouverture.php" class="btn btn-primary">Ajouter</a>
                                ...
                                <div class="table-responsive table--no-card m-b-30">
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?php  echo($et['id_compte'])?></td>
                                                <td><?php  echo($et['code_cli'])?></td>
                                                <td><?php  echo($et['num_compte'])?></td>
                                                <td><?php  echo($et['montant'])?></td>
                                                <td><?php  echo($et['dates'])?></td>
                                            
                                            
                                            <td><a href="edit-ouverture.php?id=<?= $et['id_compte'] ?>" class="btn btn-success">Edit</a>
                                                <a onclick="return confirm('Etes-Vous sûr?')" href="../model/sup-compte2.php?id=<?= $et['id_compte'] ?>" class="btn btn-danger">Delete</a>
