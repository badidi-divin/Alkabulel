<?php 
    ...
    require_once('../model/select-retrait.php');
 ?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <div class="table-responsive table--no-card m-b-30">
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?php  echo($et['num_retrait'])?></td>
                                                <td><?php  echo($et['num_compte'])?></td>
                                                <td><?php  echo($et['montant_retirer'])?></td>
                                                <td><?php  echo($et['mois'])?></td>
                                                <td><?php  echo($et['annee'])?></td>
                                                <td><?php  echo($et['dates'])?></td>
                                            <td><a href="edit-depot.php?id=<?= $et['num_retrait'] ?>" class="btn btn-success">Edit</a>
                                                <a onclick="return confirm('Etes-Vous sûr?')" href="../model/sup-depot.php?id=<?= $et['num_retrait'] ?>" class="btn btn-danger">Delete</a>
